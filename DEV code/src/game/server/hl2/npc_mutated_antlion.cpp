...
// base antlion stuff
ConVar	sk_antlionnugget_health_small("sk_antlionnugget_health_small", "5"); // "1");
ConVar	sk_antlionnugget_health_medium("sk_antlionnugget_health_medium", "10"); // "4");
ConVar	sk_antlionnugget_health_large("sk_antlionnugget_health_large", "15");  //"6");
...
//-----------------------------------------------------------------------------
int CNPC_Mutated_Antlion::GetNuggetDenomination(void)
{
...
{
	//int nHealthToGive = sk_antlionnugget_health.GetFloat() * m_nDenomination;
	int nHealthToGive;
	switch (m_nDenomination)
	{
	case NUGGET_SMALL:
		nHealthToGive = sk_antlionnugget_health_small.GetInt();
		break;
	case NUGGET_LARGE:
		nHealthToGive = sk_antlionnugget_health_large.GetInt();
		break;
	default:
		nHealthToGive = sk_antlionnugget_health_medium.GetInt();
	}
